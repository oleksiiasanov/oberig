...
- [x] 4.3 Define the new visual tokens: complex neutrals, D.VISION SDR neon-green accent, spacing, borders, shadows, and responsive breakpoints.
...
- [x] 5.3 Create modular landing sections such as Hero, Advantages, Characteristics, Comparison, Use Cases, FAQ, About, and Footer.
...
- [x] 7.10 Archive the change after acceptance.
