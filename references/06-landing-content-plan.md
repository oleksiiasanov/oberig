...
Статус: **оновлено під новий контент і двомовний сайт.**
...
— англійська. Ручний вибір мови зберігається.
...
### 6. Use cases
Cards:
- Особиста безпека під час ротації
- Захист екіпажу під час в'їзду та виїзду з позицій
- Сканування з броньованих авто
- Взаємодія з системами РЕБ
- Логістика в прифронтових зонах
