  ...
  uk: {
    ...
    comparison: {
      ...
      rows: [
        ...
        ["Гучний вентилятор", "Пасивне охолодження", "Наявність шуму від вентилятора"],
  ...
  en: {
    ...
    comparison: {
      ...
      rows: [
        ...
        ["Noisy fan", "Passive cooling", "Fan noise present"],
  ...
  fr: {
    ...
    comparison: {
      ...
      rows: [
        ...
        ["Ventilateur bruyant", "Refroidissement passif", "Bruit de ventilateur présent"],
