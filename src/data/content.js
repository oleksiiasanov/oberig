...
export const landingContent = {
  uk: {
    ...
    hero: {
      ...
      imageAlt: "D.VISION детектор дронів з антенами",
    },
    advantages: {
    ...
    design: {
      ...
      cards: [
        ...
        ["Формат віддаленого спостереження", ["Підключення до ноутбука (Windows OS), планшета та телефона (Android OS).", "Запис відео та фіксація фото."]],
    ...
    comparison: {
      ...
      text: "",
      otherLabel: "Інші",
      columns: ["Характеристика", "D.VISION", "Типовий прилад"],
      rows: [
    ...
    useCases: {
      ...
      cards: [
        ["Особиста безпека під час ротації", "Зручне кріплення на бронежилет робить D.VISION елементом індивідуального захисту бійця."],
        ...
        ["Логістика в прифронтових зонах", "Волонтери, журналісти та логістичні місії потребують надійного прикриття від дронів. D.VISION — доступне рішення для захисту кожної поїздки."],
      ],
    },
    faq: {
      kicker: "FAQ",
      title: "Часті питання",
      items: [
        ["Чим D.VISION відрізняється від детектора на основі відеоприймачів?", "D.VISION побудований на базі SDR-платформи. Live Video, спектральний сканер, «Водоспад» та аналітика RSSI/SNR дозволяють виявляти активність аналогового відеосигналу значно раніше, забезпечуючи вчасне попередження про загрозу БПЛА."],
        ...
        ["Чи виявляє D.VISION усі дрони?", "Ні, універсального детектора для всіх дронів не існує. D.VISION спеціалізований під раннє виявлення аналогових відеосигналів, які масово використовуються на ударних FPV-дронах та багатьох розвідувальних БПЛА."],
  ...
  en: {
    ...
    hero: {
      ...
      imageAlt: "D.VISION drone detector with antennas",
    },
    advantages: {
    ...
    comparison: {
      ...
      text: "",
      otherLabel: "Others",
      columns: ["Characteristic", "D.VISION", "Typical device"],
      rows: [
    ...
    useCases: {
      ...
      title: "Use cases",
      cards: [
        ["Personal safety during rotation", "A convenient vest mount makes D.VISION part of an individual protection setup."],
        ...
        ["Logistics in near-frontline zones", "Volunteers, journalists and logistics missions need reliable drone protection. D.VISION is an accessible solution for every trip."],
      ],
    },
    faq: {
      kicker: "FAQ",
      ...
      items: [
        ["How is D.VISION different from detectors based on video receivers?", "D.VISION is built on an SDR platform. Live Video, spectrum scanner, Waterfall and RSSI/SNR analytics help detect analog video-signal activity much earlier and provide timely warning about UAV threats."],
        ...
        ["Does D.VISION detect every drone?", "No. A universal detector for every drone does not exist. D.VISION specializes in early detection of analog video signals, which are widely used on FPV strike drones and many reconnaissance UAVs."],
  ...
  fr: {
    ...
    hero: {
      ...
      imageAlt: "Détecteur de drones D.VISION avec antennes",
    },
    advantages: {
      ...
      stats: [
        ["Compacité", "13 × 8 cm sans antennes"],
        ["Affichage", "Vidéo couleur"],
        ["Protection d’écran", "Protecteur PETG supplémentaire"],
      ],
    },
    design: {
      ...
      cards: [
        ...
        ["Observation à distance", ["Connexion à un ordinateur portable (Windows OS), une tablette et un téléphone (Android OS).", "Enregistrement vidéo et capture photo."]],
        ["Protection de l’appareil", ["Protection d’écran en plastique PETG ultra-résistant."]],
        ["Dimensions de l’appareil", ["Boîtier compact : 13 × 8 cm sans antennes.", "Écran optimal de 4,3 pouces."]],
    ...
    comparison: {
      kicker: "Alternatives",
      title: "Comparaison avec les solutions du marché",
      text: "",
      otherLabel: "Autres",
      columns: ["Caractéristique", "D.VISION", "Appareil typique"],
      rows: [
        ...
        ["Bruit de fonctionnement", "Refroidissement passif, sans ventilateur", "Bruit de ventilateur présent"],
    ...
    useCases: {
      ...
      cards: [
        ["Sécurité personnelle pendant les rotations", "La fixation sur gilet fait de D.VISION un élément de protection individuelle."],
        ...
        ["Logistique en zones proches du front", "Volontaires, journalistes et missions logistiques ont besoin d’une protection fiable contre les drones. D.VISION est une solution accessible pour chaque trajet."],
      ],
    },
    faq: {
      kicker: "FAQ",
      ...
      items: [
        ["En quoi D.VISION diffère-t-il des détecteurs basés sur des récepteurs vidéo ?", "D.VISION est construit sur une plateforme SDR. Live Video, scanner spectral, Waterfall et analyses RSSI/SNR aident à détecter l’activité du signal vidéo analogique beaucoup plus tôt et à prévenir à temps d’une menace UAV."],
        ...
        ["D.VISION détecte-t-il tous les drones ?", "Non. Il n’existe pas de détecteur universel pour tous les drones. D.VISION est spécialisé dans la détection précoce des signaux vidéo analogiques, largement utilisés par les drones FPV d’attaque et de nombreux UAV de reconnaissance."],
