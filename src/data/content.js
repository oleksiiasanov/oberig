...
export const landingContent = {
  uk: {
    ...
    faq: {
      ...
      items: [
        [
          "Чим D.VISION відрізняється від детектора на основі відеоприймачів?",
          "D.VISION побудований на базі SDR-платформи. Live Video, спектральний сканер, «Водоспад» та аналітика RSSI/SNR дозволяють виявляти активність аналогового відеосигналу значно раніше, забезпечуючи вчасне попередження про загрозу БПЛА.",
        ],
